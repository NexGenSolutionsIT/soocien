...
<!-- Mirrored from templates.envytheme.com/oban/default/message.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Jun 2024 21:06:12 GMT -->
    ...
    <div class="body-content">
        ...
        <div class="message-full-area">
            ...
            <div class="inbox-area">
                <div class="container">
                    <div class="inbox-area-item inbox-area-item-sender">
                        <!-- "inbox-area-item" class is used for the coversation which is started from a time. "inbox-area-item-sender" class is used for the sender message. -->
                        <div class="message-time">05/01/2024 05:05 AM</div>
                        <!-- "message-time" class is used for the time that the message has been sent or received. -->
                        <div class="inbox-message-item">
                            <!-- "inbox-message-item" class is used for individual message. -->
                            ...
                            <div class="inbox-message-text-item">
                                <div class="inbox-message-text">
                                    ...
                                    incididunt ut labore et dolore magna aliqua gravida.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="inbox-area-item inbox-area-item-me">
                        <!-- "inbox-area-item" class is used for the coversation which is started from a time. "inbox-area-item-me" class is used for the self message. -->
                        <div class="inbox-message-item">
                            <!-- "inbox-message-item" class is used for individual message. -->
                            <div class="inbox-message-text-item">
                                <div class="inbox-message-text">
                    ...
                    <div class="inbox-area-item inbox-area-item-sender">
                        <!-- "inbox-area-item" class is used for the coversation which is started from a time. "inbox-area-item-sender" class is used for the sender message. -->
                        <div class="message-time">08/01/2024 10:10 AM</div>
                        <!-- "message-time" class is used for the time that the message has been sent or received. -->
                        <div class="inbox-message-item">
                            <!-- "inbox-message-item" class is used for individual message. -->
                            <div class="inbox-message-thumb">
