...
<!-- Mirrored from templates.envytheme.com/oban/default/transaction-verification.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Jun 2024 21:06:12 GMT -->
        ...
        <div class="container">
            ...
            <div class="page-header">
                <div class="page-header-title page-header-item">
                    <h3>Transaction Verification</h3>
                    <p>Mobile payment please confirm or cancel the payment</p>
                </div>
            </div>
            <!-- Page-header -->
            ...
            <div class="payment-list pb-30">
                <div class="payment-list-details">
                    ...
                    <div class="payment-list-item payment-list-info">Success</div>
                </div>
                <div class="payment-list-details">
                    <div class="payment-list-item payment-list-title">Date</div>
                    <div class="payment-list-item payment-list-info">15 Jan, 2024</div>
                </div>
                <div class="payment-list-details">
                    <div class="payment-list-item payment-list-title">From</div>
                    <div class="payment-list-item payment-list-info">Oban Bank</div>
                </div>
                <div class="payment-list-details">
                    <div class="payment-list-item payment-list-title">To</div>
                    <div class="payment-list-item payment-list-info">**** **** **** 1542</div>
                </div>
                <div class="payment-list-details">
                    <div class="payment-list-item payment-list-title">Transaction Number</div>
                    <div class="payment-list-item payment-list-info">BN2541WL3658</div>
                </div>
                <div class="payment-list-details">
                    <div class="payment-list-item payment-list-title">Transaction Category</div>
                    <div class="payment-list-item payment-list-info">Transfer</div>
                </div>
                <div class="payment-list-details">
                    <div class="payment-list-item payment-list-title">Amount</div>
                    <div class="payment-list-item payment-list-info">$ 185.00</div>
                </div>
            </div>
            <!-- Payment-list -->
            ...
            <div class="button-group pb-15">
                <div class="row gx-2">
                    <div class="col-6">
                        <a href="#" class="btn main-btn main-btn-black">Cancel</a>
                    </div>
                    <div class="col-6">
                        <a href="#" class="btn main-btn" data-bs-toggle="modal"
                            data-bs-target="#confirmPayment">Confirm</a>
                    </div>
                </div>
            </div>
            <!-- Button-group -->
                ...
                <div class="container">
                    ...
                    <div class="modal-body modal-body-center">
                        <form class="text-center">
                            <h3>Transaction Has Been Successful</h3>
                            <button type="submit" class="btn main-btn main-btn-lg full-width">Go</button>
                        </form>
                    </div>
                </div>
            </div>
