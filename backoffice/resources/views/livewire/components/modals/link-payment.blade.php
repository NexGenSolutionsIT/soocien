                            ...
                            <div wire:loading class="btn color-white main-btn main-btn-lg btn-send full-width mb-10">
                                <span style="font-size: 15px;">
                                    <svg style="width: 22px" version="1.1" id="L7"
                                        ...
                                        <path fill="#fff" d="M82,35.7C74.1,18,53.4,10.1,35.7,18S10.1,46.6,18,64.3l7.6-3.4c-6-13.5,0-29.3,13.5-35.3
                                            s29.3,0,35.3,13.5L82,35.7z">
                                            <animateTransform attributeName="transform" attributeType="XML"
                                                              type="rotate" dur="2s" from="0 50 50" to="360 50 50"
                                                              repeatCount="indefinite" />
                                        </path>
                    ...
                    @else
                        <div class="boxpix">
                            <div style="display: flex; flex-direction: column;">
                                ...
                                <button onclick="attPage()" type="button" style="font-size: 14px;"
                                        class="btn main-btn mt-3 main-btn-lg buttonpix">Criar Novo Link</button>
                            </div>
                        </div>
                    @endif
                </div>
