    ...
    <div class="container">
        <div class="navbar-content">
            <div class="navbar-content-item">
                <a href="{{ route('dashboard.get') }}" class="">
            ...
            <div class="navbar-content-item">
                <a href="{{ route('keysapi.get') }}">
                    <svg fill="#000000" height="27px" width="64px" version="1.1" id="Capa_1"
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        viewBox="0 0 511.00 511.00" xml:space="preserve" stroke="#000000" stroke-width="0.00511">
                        <g id="SVGRepo_bgCarrier5" stroke-width="0" />

                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC"
                            stroke-width="14.308000000000002" />

                        <g id="SVGRepo_iconCarrie5">
                            <g>
                                <path
            ...
            <div class="navbar-content-item">
                <a href="{{ route('profile.get') }}">
                    <img style="width: 24px;" src="assets/images/sys-soocien/pessoa.svg" alt="profile" />
                    Dados
                </a>
            </div>
        </div>
